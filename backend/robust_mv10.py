...
def mv(df, etflist = ['BNDX', 'SPSM', 'SPMD', 'SPLG', 'VWO', 'VEA', 'MUB', 'EMB'], short = 0, maxuse = 1, normal = 1, startdate = 199302, enddate = 202312):
    ...
    try: 
        ...
        # Robust MV Portfolio
            ...
            print('-------------------------------')
            print('-------------------------------')
            print(maxSR, maxSR_ret, maxSR_std, robw)
...
# %%
# etflist = ['BNDX', 'SPSM', 'SPLG', 'IEV','VWO','MUB']
##etflist = ['BNDX', 'SPSM', 'SPLG', 'IEV','VWO','MUB','AVUV']
##etflist = ['BNDX', 'SPSM', 'SPLG', 'IEV','VWO','MUB','AVUV','BTAL']
...
etflist = ['BNDX', 'SPSM', 'SPLG', 'IEV','VWO','MUB']
# mv(df, etflist, 0, 0, 1, 197012, 202412)
# mv(df, etflist, 1, 0, 1, 197012, 202412)


mv(df, etflist, 0, 0, 0, 197012, 202412)
